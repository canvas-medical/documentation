...
- Commands can be added to [encounter, review, or data import notes](https://canvas-medical.help.usepylon.com/articles/6785045644-appointment-event-note-types){:target="_blank"}. It is important to note that encounter and review notes must be unlocked and should not be deleted.
