...
| `context`\*\* | _dict_     | `false`  | A dictionary that may contain the key 'conditions'. If 'conditions' is included, it will populate the indications field of the `image` command.                                            |
