...
| ADD_APPOINTMENT_LABEL                                    | Add one or more labels to an appointment (max 3 total). Check out [Appointment Label Effects](/sdk/effect-appointment-labels/).                                                                             |
| REMOVE_APPOINTMENT_LABEL                                 | Remove one or more labels from an appointment. Check out [Appointment Label Effects](/sdk/effect-appointment-labels/).                                                                                     |
