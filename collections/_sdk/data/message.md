...
| `delivered`            | `DateTime`                                  | Timestamp when the transmission was delivered. Null until it is delivered.  |
| `failed`               | `DateTime`                                  | Timestamp when the transmission failed. Null until it has failed.           |
