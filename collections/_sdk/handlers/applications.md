...
> **Tip:** If your Note Application is named "Note", it may cause confusion with the built-in Note tab. Administrators can rename the built-in tab using the `NOTE_BODY_TAB_LABEL` Constance Config, found in the General Section of your instance Settings, to avoid duplication.
