...
{% tab appointment-create-response 401 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-create-response 403 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-create-response 405 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-create-response 412 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-create-response 422 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-update-response 401 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-update-response 403 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-update-response 404 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-update-response 405 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-update-response 412 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
...
{% tab appointment-update-response 422 %}
```json
{
  "resourceType": "OperationOutcome",
  "issue": [
