    ...
    blocks:
      - type: apidoc
        ...
        description: >-
          ...
          <br><br>Organizations come from four different Canvas data types: Organizations, Vendors, Insurers, and Service Providers. Organizations, Vendors, and Insurers can be managed in Canvas Settings. Service Providers are created through several Canvas workflows — placing a referral, placing an imaging order, adding an external member to a patient's Care Team, and faxing an external contact — and they appear as Organization participants on patient [Care Teams](/api/careteam). FHIR Organizations created by Insurers in Canvas are useful in the [FHIR Coverage](/api/coverage) payor attribute.
        attributes:
          - name: resourceType
