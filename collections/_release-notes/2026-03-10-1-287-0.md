...
- Adds a new PDF generator utility that enables plugins to generate PDFs either from a hosted HTML page or from raw HTML content.
- Adds Python 3.13 support to the SDK.
- Creates a new claim effect for updating provider information on a claim.
