...
- Adds an optional description field to [`ClinicalQuantity`](/sdk/commands/#clinicalquantity) to allow narrowing the type to dispense when multiple clinical quantity options are available for the same NDC and qualifier code.
