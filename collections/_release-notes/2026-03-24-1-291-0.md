...
- Action buttons now support custom styling via BUTTON_TEXT_COLOR and BUTTON_BACKGROUND_COLOR class constants. [Read more.](/sdk/handlers-action-buttons/#class-attributes)
