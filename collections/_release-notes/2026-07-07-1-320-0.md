...
- Multi-factor authentication is now enforced for API access, not just the web app. A session signed in with only a password can no longer read data until the second factor is completed.
