...
Adds permissions to users to support document uploads via the patient portal. [Read more about out beta program here](/product-updates/patient-portal/#upload-documents) and to learn more about managing your patient portal [read more here](https://canvas-medical.help.usepylon.com/articles/7348270931-managing-the-patient-portal#navigating-the-patient-portal-30).
