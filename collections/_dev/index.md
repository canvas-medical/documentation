...
Ready to dive in? [Get started!](/dev/overview)
...
* [Series 1](/dev/overview): Introduction to the Canvas Developer Platform
...
* Additional Learning
 ...
 Follow the links at bottom of each page for the next lesson. Or, to skip ahead or review a section, use the direct links in the left hand menu of this page.

## Next Steps
--> [Series 1: Overview](/dev/overview)