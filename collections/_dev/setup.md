...
### Step 6: Configure Your Protocol
...
class PatientWelcomeBanner(BaseProtocol):
    ...
    def compute(self) -> list[Effect]:
        ...
        log.info(self.target) # {id: 2sdfsd832394}
 ```

3. **Return Effects** to modify workflows or data in Canvas

 - TRY IT: Add a banner alert to the patient profile
...
class PatientWelcomeBanner(BaseProtocol):
    ...
    """Listens for patient creation and returns an alert banner"""
        log.info(self.context) # empty
        log.info(self.target) # {2sdfsd832394}
...
If you changed your class name in Step 6, you'll need to update the class name in CANVAS_MANIFEST.json:
...
<img src="/assets/images/new_patient_banner.png" alt="A patient chart in Canvas Medical EHR showing an alert banner that says 'This is a new patient'"/>
---
